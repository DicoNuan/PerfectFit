...
public class WeekView extends View {
     ...
     * @param date The day.
     * @param startFromPixel The left position of the day area. The events will never go any left from WeekView.this value.
    ...
    private class EventRect {
         ...
         * be stored in "event".
         * @param event Represents the event which WeekView.this instance of rectangle represents.
    ...
    /**
     * Gets more events of one/more month(s) if necessary. WeekView.this method is called when the user is
    ...
    /**
     * Calculates the left and right positions of each events. WeekView.this comes handy specially if events
     * are overlapping.
    ...
    public void setOnEventClickListener (EventClickListener listener) {
        WeekView.this.mEventClickListener = listener;
    }
    ...
    public void setMonthChangeListener(MonthLoader.MonthChangeListener monthChangeListener) {
        WeekView.this.mWeekViewLoader = new MonthLoader(monthChangeListener);
    }
    ...
    public void setWeekViewLoader(WeekViewLoader loader){
        WeekView.this.mWeekViewLoader = loader;
    }
    ...
    public void setEventLongPressListener(EventLongPressListener eventLongPressListener) {
        WeekView.this.mEventLongPressListener = eventLongPressListener;
    }

    public void setEmptyViewClickListener(EmptyViewClickListener emptyViewClickListener){
        WeekView.this.mEmptyViewClickListener = emptyViewClickListener;
    }
    ...
    public void setEmptyViewLongPressListener(EmptyViewLongPressListener emptyViewLongPressListener){
        WeekView.this.mEmptyViewLongPressListener = emptyViewLongPressListener;
    }
    ...
    public void setScrollListener(ScrollListener scrolledListener){
        WeekView.this.mScrollListener = scrolledListener;
    }
    ...
    public void setDateTimeInterpreter(DateTimeInterpreter dateTimeInterpreter){
        WeekView.this.mDateTimeInterpreter = dateTimeInterpreter;
    ...
    public void setNumberOfVisibleDays(int numberOfVisibleDays) {
        WeekView.this.mNumberOfVisibleDays = numberOfVisibleDays;
        mCurrentOrigin.x = 0;
        mCurrentOrigin.y = 0;
        invalidate();
    }
     ...
     * <p>
     *     <b>Note:</b> WeekView.this method will only work if the week view is set to display more than 6 days at
     *     once.
     * </p>
    ...
    public void setDayNameLength(int length) {
        ...
        WeekView.this.mDayNameLength = length;
    }
    ...
    public void setOverlappingEventGap(int overlappingEventGap) {
        WeekView.this.mOverlappingEventGap = overlappingEventGap;
        invalidate();
    }
    ...
    /**
     * Set the top and bottom margin of the event. The event will release WeekView.this margin from the top
     * and bottom edge. WeekView.this margin is useful for differentiation consecutive events.
     * @param eventMarginVertical The top and bottom margin.
     */
    public void setEventMarginVertical(int eventMarginVertical) {
        WeekView.this.mEventMarginVertical = eventMarginVertical;
        invalidate();
    }
    ...
    public void setXScrollingSpeed(float xScrollingSpeed) {
        WeekView.this.mXScrollingSpeed = xScrollingSpeed;
    }
    ...
    public void setShowDistinctWeekendColor(boolean showDistinctWeekendColor) {
        WeekView.this.mShowDistinctWeekendColor = showDistinctWeekendColor;
        invalidate();
    }
    ...
    public void setShowDistinctPastFutureColor(boolean showDistinctPastFutureColor) {
        WeekView.this.mShowDistinctPastFutureColor = showDistinctPastFutureColor;
        invalidate();
    }
    ...
    public void setShowNowLine(boolean showNowLine) {
        WeekView.this.mShowNowLine = showNowLine;
        invalidate();
    }
    ...
    public void setNowLineColor(int nowLineColor) {
        WeekView.this.mNowLineColor = nowLineColor;
        invalidate();
    }
    ...
    public void setNowLineThickness(int nowLineThickness) {
        WeekView.this.mNowLineThickness = nowLineThickness;
        invalidate();
    }
    ...
    public interface ScrollListener {
         ...
         *
         * (WeekView.this will also be called during the first draw of the weekview)
    ...
    /**
     * Returns a calendar instance at the start of WeekView.this day
