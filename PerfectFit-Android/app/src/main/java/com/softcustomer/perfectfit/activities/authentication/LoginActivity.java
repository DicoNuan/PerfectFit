 ...
 */
public class LoginActivity extends HomeButtonBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindActivityStarter(R.id.textview_forgot_password, ForgotPasswordActivity.class);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                UserSession.start(LoginActivity.this);
                setResult(SUCCESS);
                finish();
            } else {
